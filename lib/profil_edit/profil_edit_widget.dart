...
import 'profil_edit_model.dart';
export 'profil_edit_model.dart';

class ProfilEditWidget extends StatefulWidget {
  const ProfilEditWidget({Key? key}) : super(key: key);

  @override
  _ProfilEditWidgetState createState() => _ProfilEditWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> profilEditUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final profilEditUsersRecord = profilEditUsersRecordList.isNotEmpty
            ? profilEditUsersRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.network(
                                        profilEditUsersRecord!.photoUrl,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.nameController ??=
                                    ...
                                    text: profilEditUsersRecord?.displayName,
                                  ),
                                  obscureText: false,
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.addressController ??=
                                      TextEditingController(
                                    text: profilEditUsersRecord?.address,
                                  ),
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Address',
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await profilEditUsersRecord!.reference
